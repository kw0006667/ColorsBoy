...
{	
	...
	var chromaticBloom : SerializedProperty;
	...
	function OnEnable () {
		...
		chromaticBloom = serObj.FindProperty("chromaticBloom");
    ...
    function OnInspectorGUI () {        
    	...
    	if (1 == tweakMode.intValue) {
    		...
    		EditorGUILayout.PropertyField(chromaticBloom, new GUIContent(" Chromatic", "Create outlines around bright areas"));
		}
    	EditorGUILayout.Separator ();			
