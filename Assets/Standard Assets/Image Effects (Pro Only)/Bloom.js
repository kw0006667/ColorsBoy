...
class Bloom extends PostEffectsBase {
	...
	public var chromaticBloom : float = 0.0f;
	...
	function OnRenderImage (source : RenderTexture, destination : RenderTexture) {			
		...
		screenBlend.SetFloat("_ChromaticBloom", 0.0f);
		screenBlend.SetFloat("_ChromaticBloomThresh", 1.0f);
		...
		screenBlend.SetFloat("_ChromaticBloom", chromaticBloom);
		screenBlend.SetFloat("_ChromaticBloomThresh", bloomThreshhold * (bloomThreshholdColor.r * 0.3f + bloomThreshholdColor.g * 0.59f + bloomThreshholdColor.b * 0.11f));		
